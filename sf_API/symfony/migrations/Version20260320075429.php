 ...
 */
final class Version20260320075429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE registration (id INT AUTO_INCREMENT NOT NULL, registered_at DATETIME NOT NULL, user_id INT DEFAULT NULL, activity_id INT DEFAULT NULL, INDEX IDX_62A8A7A7A76ED395 (user_id), INDEX IDX_62A8A7A781C06096 (activity_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
